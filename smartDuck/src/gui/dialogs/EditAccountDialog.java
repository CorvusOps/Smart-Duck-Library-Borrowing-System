...
public class EditAccountDialog extends JDialog {
	...
	public static void main(String[] args) {
		...
		try {
			EditAccountDialog dialog = new EditAccountDialog(AccountID);
	 ...
	 * Create the dialog.
	 */
	public EditAccountDialog(String AccountID) {
		...
		JLabel lblAddAccount = new JLabel("Edit Account");
		lblAddAccount.setIcon(new ImageIcon(EditAccountDialog.class.getResource("/img/addUser_50px.png")));
	...
	public void setTexts(String AccountID) {
		//set the texts to the JTextFields of the details of the Book and the Borrower

			Account accountValues = BorrowFormCRUD.getAccountDetails(AccountID);
			
			IDtextField.setText(accountValues.getAccountId());
			NametextField.setText(accountValues.getName());
			CoursetextField.setText(accountValues.getCourse());
			DepartmenttextField.setText(accountValues.getDepartment());
			EmailtextField.setText(accountValues.getEmail());
	}
